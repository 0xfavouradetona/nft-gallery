...
const Home = () => {
  ...
  const fetchNFTs = async() => {
    ...
    const api_key = "B9lYYjnlgq7ec8TkcY0tVs1Pvg82hg6M"
    const baseURL = `https://eth-mainnet.alchemyapi.io/v2/B9lYYjnlgq7ec8TkcY0tVs1Pvg82hg6M/getNFTs/`;
  ...
  const fetchNFTsForCollection = async () => {
    if (collection.length) {
      ...
      const api_key = "B9lYYjnlgq7ec8TkcY0tVs1Pvg82hg6M"
      const baseURL = `https://eth-mainnet.alchemyapi.io/v2/B9lYYjnlgq7ec8TkcY0tVs1Pvg82hg6M/getNFTsForCollection/`;
